...
def make_qiuzhi_example() -> dict:
    """Creates a random input example for the Qiuzhi policy."""
    return {
...
class QiuzhiInputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        state = transforms.pad_to_dim(data["observation/states"], self.action_dim)
